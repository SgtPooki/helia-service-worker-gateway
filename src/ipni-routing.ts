 ...
 */
class IpniRouting implements ContentRouting, Startable {
...
export function ipniRouting (protocol :string, host: string, port: string): (components?: any) => ContentRouting {
